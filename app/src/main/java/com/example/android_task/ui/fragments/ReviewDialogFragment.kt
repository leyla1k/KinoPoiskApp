...
/*
    ...
    private val review:String by lazy { navArgs<ReviewDialogFragment>().value.review }
*/

    private val review: String by lazy {
        requireArguments().getString("review") ?: throw IllegalArgumentException("Review argument is missing")
    }
